-- Extra entries are accepted rather than bounced, and the entrant is told
-- plainly that they now hold more than one and will be passed over unless it
-- is fixed. Refusing silently taught people to try again with another email;
-- accepting and saying so does not.
--
-- The cap is abuse control, not policy: past it there is nothing more to learn
-- about the person and the table stops growing.
